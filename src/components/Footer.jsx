    ...
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        ...
        <div>
            ...
            <p className='text-sm mt-2 mb-0'>The latest news, articles, and resources, sent to you inbox weekly.</p>
            <div className='flex gap-2 text-sm'>
                <input type='email' placeholder='Enter Your Email' className='w-full p-3 text-sm outline-none rounded
                 dark: text-gray-200 bg-transparent border-gray-300 dark:border-gray-500' />
      ...
      <div>
        <p>Copyright 2025 @ agency.io - GrateStack - All Right Reserved.</p>
