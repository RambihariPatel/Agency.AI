  ...
  return (
    <div>
      ...
      lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <from className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full">
            <div>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea rows={8} placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' name='' id='' />
            </div>
