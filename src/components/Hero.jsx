  ...
  return (
    ...
    dark:text-white'>
        ...
        <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75
         w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning
            big ideas into interactive digital expreriences.
        </p>

        <div className='relative'>
            <img src={assets.hero_img} alt='' className='w-full max-w-6xl' />
            <img src={assets.bgImage1} className='absolute -top-40 -right-40 
            sm:-top-24 sm:-right-24-z-10 dark:hidden' />
        </div>
